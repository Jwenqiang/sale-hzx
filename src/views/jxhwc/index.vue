...
div(:class='$style.wrap')
  div(:class='$style.main', v-lazy-container='{ selector: "img[data-src]" }')
    //- the-nav(ref='nav', v-model='activeNav')/

    img(
      :class='$style.banner',
      :data-src='`${$_publicPath}img/jxhwc/banner.png`'
    )/

    img(
      :class='$style.bannerPC',
      :data-src='`${$_publicPath}img/jxhwc/banner-pc.jpg`'
    )/
...
<script>
import '@/components/base-card/theme-ycmt/index.less'
